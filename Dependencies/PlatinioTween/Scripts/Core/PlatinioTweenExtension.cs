///改动:
///添加了兼容嵌套UI的版本:
///<see cref="PlatinioTweenExtension.MoveUI_Modified(RectTransform, Vector2, RectTransform, float)"/>
///为TMP_Text扩展了淡入淡出
///<see cref="PlatinioTweenExtension.FadeIn(TMP_Text, float)"/>
///<see cref="PlatinioTweenExtension.FadeOut(CanvasGroup, float)"/>
///添加了支持TMP_Text的淡入淡出
///<see cref="PlatinioTweenExtension.ColorTween(TMP_Text, Color, float)"/>
///
///
...
public static class PlatinioTweenExtension
{
    ...
    public static BaseTween FadeIn(this TMP_Text text, float t)
    {
        return PlatinioTween.instance.Fade(text, 1, t);
    }
    public static BaseTween FadeOut(this TMP_Text text, float t)
    {
        return PlatinioTween.instance.Fade(text, 0, t);
    }
    ...
    /// 该方法不适用于有嵌套层次的UI元素 
    /// </summary>
    [System.Obsolete("该方法不适用于有嵌套层次的UI元素")]
    ...
    public static BaseTween MoveUI_Modified(this RectTransform rect, Vector2 absolutePosition, RectTransform canvas, float time)
    {
        return PlatinioTween.instance.MoveUI_Modified(rect , absolutePosition , canvas, time);
    }
