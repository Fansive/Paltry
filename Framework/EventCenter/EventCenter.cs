...
namespace Paltry
{
    ...
    {
        private static Dictionary<string,Action> EventDict;
        private static Dictionary<string, Delegate> EventWithArgsDict;
        ...
        /// </summary>
        public static void Trigger<TEventArg>(string name,TEventArg eventArg)
        {
        ...
        public static void AddListener<TEventArg>(string name,Action<TEventArg> listener)
        {
            if (EventWithArgsDict.TryGetValue(name, out Delegate delegates))
            {
                Action<TEventArg> eventHandlers = delegates as Action<TEventArg>;
        ...
        /// </summary>
        public static void RemoveListener(string name,Action listener)
        {
            if (EventDict.ContainsKey(name))
                EventDict[name] -= listener;
        }
        ...
        /// </summary>
        public static void RemoveListener<TEventArg>(string name,Action<TEventArg> listener)
        {
            if (EventWithArgsDict.TryGetValue(name, out Delegate delegates))
            {
                Action<TEventArg> eventHandlers = delegates as Action<TEventArg>;
