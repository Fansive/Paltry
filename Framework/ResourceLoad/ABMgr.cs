...
namespace Paltry
{
    ...
    public class ABMgr:CSharpSingleton<ABMgr>
    {
        ...
        /// 卸载AB包
        /// </summary>
        /// <param name="alsoUnloadAsset">是否同时卸载加载的资源</param>
        public void UnloadAB(string abName,bool alsoUnloadAsset=false)
        {
            if(ABDict.TryGetValue(abName,out AssetBundle ab))
            {
                ab.Unload(alsoUnloadAsset);
        ...
        /// </summary>
        /// <param name="alsoUnloadAsset">是否同时卸载加载的资源</param>
        public void UnloadABAsync(string abName, bool alsoUnloadAsset = false,System.Action callback=null)
        {
            if (ABDict.TryGetValue(abName, out AssetBundle ab))
            {
                ...
                {
                    var asyncOp = ab.UnloadAsync(alsoUnloadAsset);
