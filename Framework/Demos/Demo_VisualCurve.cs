    ...
    public class Demo_VisualCurve : MonoBehaviour
    {
        ...
        void DrawCurves()
        {
            ...
            foreach (Curve curve in curves)
            {
                ...
                textObj.transform.SetParent(canvas.gameObject.transform);
                ...
                circle.transform.SetParent(LR.gameObject.transform);
                ...
                circle.transform.localScale = 0.05f * Scale * Vector3.one;
